    ...
    <>
        <div className="flex">
            ...
            <div style={{ marginLeft: 40, width: "100vw" }}>
                  <h1 className="font-medium text-3xl mt-16">Report Problem</h1>
                  ...
                  <button onClick={handleSubmit} class="mt-2 mb-64 bg-black hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-center mr-2">
                        Submit
                  </button>
                 </div>
                 {!!snackbar && (
