    ...
    <div className=' pt-12'>
        <div className='lg:px-[130px] px-[60px] max-sm:max-w-[500px]'>
            ...
            <div className='flex lg:flex-row max-lg:flex-col  mt-12 border-b border-b-gray-500 lg:pb-16 '>
                ...
                <img src="src\assets\images\LandingPage\dealership.jpg" alt="dealership" className='w-[30%] mt-[-56px] max-xl:hidden' />
            </div>
        ...
        <img src="src\assets\images\LandingPage\footer.png" alt="car" className='w-full '/>
    </div>
  )
}
