  ...
  return (
    ...
    >
        ...
        <form onSubmit={handleSubmitForm} className=" max-sm:my-8 my-auto py-6 px-9 w-[40%]  max-xl:overflow-y-scroll ml-[30%] bg-white rounded-md
          ...
          <div>
            ...
            <input type="text" name="name" id="name" value={formState.name}  onChange={handleChange}
                className="mt-2  w-[100%] rounded-md border border-[#e0e0e0] bg-white py-[8px] px-4 text-base font-medium outline-none focus:border-[#6A64F1] focus:shadow-md"
            />
          </div>
          ...
          <div className="mt-[20px]">
            <div className='col-span-1'>
              ...
              <select
                  ...
                  id="status"
                  name="status"
                  className="mt-2 w-[100%] rounded-md border border-[#e0e0e0] bg-white py-[8px] px-4 pb-[12px] font-medium outline-none focus:border-[#6A64F1] focus:shadow-md"
                >
        ...
        <div className='bg-white my-auto min-h-[460px] flex flex-col w-[400px] max-h-[550px] m-[30px] rounded-md ml-[10px]
            ...
            <input type="file" onChange={handleImageChange} ref={inputRef} className='hidden'/>
            <button className="hover:shadow-form w-[200px] h-[40px] mx-auto my-auto   rounded-md bg-[#6A64F1]   text-center text-base font-semibold text-white outline-none" 
