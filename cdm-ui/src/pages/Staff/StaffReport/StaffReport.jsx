      ...
      <div className={`modal ${report ? 'active' : ''}`}>
        <div className="modal-content">
          ...
          <div className='detail-box'>
            <p className='flex mt-6 ml-10'><strong className='mr-12'>{report.customer}</strong> <div className='mr-12'>{report.date}</div> {report.status.toUpperCase()}</p>
    ...
    <div>
        ...
        <table className='mt-12 ml-10'>
            ...
            {reports.map((report, index) => (
                <tr key={index}>
                <td className='customer-col'>{report.customer}</td>
